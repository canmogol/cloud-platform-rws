package com.cloudplatform.app.version.model;
...
@NamedQueries(
        @NamedQuery(name = "LATEST_VERSION_LAST", query = "select v from LatestVersion v order by v.major, v.minor, v.patch desc")
)
public class LatestVersion extends BaseModelID<Integer> {
